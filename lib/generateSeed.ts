...
const SPECIES: SpeciesDef[] = [
  ...
  { species: 'Andean Condor',     region: 'South America', lat: -32, lng: -70, spread: 9, archetype: 'bird' },
  ...
  { species: 'Red Deer',          region: 'Europe', lat: 56, lng: -4, spread: 7, archetype: 'prey' },
  { species: 'European Hedgehog', region: 'Europe', lat: 51, lng: 8, spread: 9, archetype: 'prey' },
  // AFRICA
  { species: 'African Elephant',  region: 'Africa', lat: -2, lng: 35, spread: 9, archetype: 'prey' },
  ...
  { species: 'Zebra',             region: 'Africa', lat: -3, lng: 35, spread: 8, archetype: 'prey' },
  ...
  { species: 'Japanese Macaque',  region: 'Asia', lat: 36, lng: 138, spread: 5, archetype: 'primate' },
  ...
  { species: 'Siberian Tiger',    region: 'Asia', lat: 47, lng: 135, spread: 8, archetype: 'predator' },
  ...
  { species: 'Koala',             region: 'Oceania', lat: -33, lng: 151, spread: 7, archetype: 'prey' },
  { species: 'Kiwi',              region: 'Oceania', lat: -41, lng: 173, spread: 5, archetype: 'bird' },
  ...
  { species: 'Platypus',          region: 'Oceania', lat: -33, lng: 150, spread: 7, archetype: 'marine' },
  // PACIFIC OCEAN
